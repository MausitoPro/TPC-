...
public class Carrito
{
    ...
    public void actualizar_stock () {
        ...
        foreach (Producto p in productos_carrito) {
            ...
            Producto? aux = this.tienda.get_producto_byname(p.getNombre());
...
public class Tienda
{
    ...
    public void mostrar_productos_carrito()
    {
    ...
    public double comprar(double dinero)
    {
        ...
        if (dinero >= importe) {
            ...
            this.carrito.actualizar_stock();

            this.carrito.reset_carrito();
...
class Program
{
    ...
    private static void interfaz_cliente (Tienda tienda) {
        ...
        while (!exit) {
            ...
            if (option != null) {
                ...
                {
                    case 1: 
                        tienda.mostrar_productos_carrito();
                        break;
                    case 2:
    ...
    private static void interfaz_removerProducto_carrito (Tienda tienda) {
        ...
        while (!success) {
            ...
            if (nombre != null) {
                ...
                if (tienda.getCarrito().producto_carrito_exists(nombre)) {
    ...
    private static void interfaz_pagar (Tienda tienda) {
        ...
        while (!success) {
            ...
            double precio_total = tienda.getCarrito().get_total_a_pagar();
